...
-(void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext
{
    ...
    // 获取动画的源控制器和目标控制器
    XHCustomerAnimaVC * fromVC = (XHCustomerAnimaVC *)[transitionContext viewControllerForKey:UITransitionContextFromViewControllerKey];
    XHAnimationPushVC *toVC = (XHAnimationPushVC *)[transitionContext viewControllerForKey:UITransitionContextToViewControllerKey];
    
    //获取容器视图
    UIView *contView = [transitionContext containerView];
    
//    if (![fromVC isKindOfClass:[XHCustomerAnimaVC class]]) {
//        return;
//    }
    UIButton *button = fromVC.curronButton;
